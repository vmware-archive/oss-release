...
#
#   DESCRIPTION: Automate the branch merge-forward process for SaltStack/salt-jenkins.git
#
#=============================================================================================
...
Automate the branch merge-forward process for SaltStack/salt-jenkins.git
...
setup_branch_names() {
    ...
    if [ ${EASY_UPSTREAM_BRANCH} == "master" ]; then
        DOWNSTREAM_BR="2019.2"
    elif [ ${EASY_UPSTREAM_BRANCH} == "2019.2"  ]; then
